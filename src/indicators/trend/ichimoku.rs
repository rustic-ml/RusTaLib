...
pub fn calculate_ichimoku_cloud(df: &DataFrame, high_col: &str, low_col: &str, close_col: &str, tenkan: usize, kijun: usize, senkou_b: usize) -> PolarsResult<(Series, Series, Series, Series, Series)> {
