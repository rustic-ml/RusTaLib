...
use ta_lib_in_rust::indicators::oscillators::{calculate_rsi, calculate_macd};
...
fn main() -> Result<(), PolarsError> {
    ...
    let opens = Series::new(
        "open".into(),
        &[
            100.0, 101.5, 103.0, 104.2, 105.7, 107.0, 108.2, 109.6, 111.2, 112.5,
            113.8, 115.0, 116.5, 118.0, 119.3, 120.6, 122.0, 123.5, 124.8, 126.0,
            127.2, 128.5, 129.7, 131.0, 132.2, 133.3, 134.5, 135.6, 136.8, 138.0,
            139.0, 139.8, 140.5, 141.2, 141.8, 142.5, 142.9, 143.5, 143.8, 144.0,
            144.2, 143.9, 144.1, 143.8, 143.5, 142.9, 142.0, 141.2, 140.3, 139.0,
            137.5, 136.0, 134.5, 133.0, 131.5, 130.0, 128.5, 127.0, 125.5, 123.5,
    ...
    let highs = Series::new(
        "high".into(),
        &[
            102.0, 103.5, 105.0, 106.2, 107.7, 109.0, 110.2, 111.6, 113.2, 114.5,
            115.8, 117.0, 118.5, 120.0, 121.3, 122.6, 124.0, 125.5, 126.8, 128.0,
            129.2, 130.5, 131.7, 133.0, 134.2, 135.3, 136.5, 137.6, 138.8, 140.0,
            141.0, 141.8, 142.5, 143.2, 143.8, 144.5, 144.9, 145.5, 145.8, 146.0,
            146.2, 145.9, 146.1, 145.8, 145.5, 144.9, 144.0, 143.2, 142.3, 141.0,
            139.5, 138.0, 136.5, 135.0, 133.5, 132.0, 130.5, 129.0, 127.5, 125.5,
    ...
    let lows = Series::new(
        "low".into(),
        &[
            99.0, 100.5, 102.0, 103.2, 104.7, 106.0, 107.2, 108.6, 110.2, 111.5,
            112.8, 114.0, 115.5, 117.0, 118.3, 119.6, 121.0, 122.5, 123.8, 125.0,
            126.2, 127.5, 128.7, 130.0, 131.2, 132.3, 133.5, 134.6, 135.8, 137.0,
            138.0, 138.8, 139.5, 140.2, 140.8, 141.5, 141.9, 142.5, 142.8, 143.0,
            143.2, 142.9, 143.1, 142.8, 142.5, 141.9, 141.0, 140.2, 139.3, 138.0,
            136.5, 135.0, 133.5, 132.0, 130.5, 129.0, 127.5, 126.0, 124.5, 122.5,
    ...
    let closes = Series::new(
        "close".into(),
        &[
            101.5, 103.0, 104.2, 105.7, 107.0, 108.2, 109.6, 111.2, 112.5, 113.8, 
            115.0, 116.5, 118.0, 119.3, 120.6, 122.0, 123.5, 124.8, 126.0, 127.2, 
            128.5, 129.7, 131.0, 132.2, 133.3, 134.5, 135.6, 136.8, 138.0, 139.0, 
            139.8, 140.5, 141.2, 141.8, 142.5, 142.9, 143.5, 143.8, 144.0, 144.2, 
            143.9, 144.1, 143.8, 143.5, 142.9, 142.0, 141.2, 140.3, 139.0, 137.5, 
            136.0, 134.5, 133.0, 131.5, 130.0, 128.5, 127.0, 125.5, 123.5, 121.5, 
    ...
    let volumes = Series::new(
        "volume".into(),
        &[
            150000, 160000, 165000, 170000, 175000, 180000, 185000, 190000, 195000, 200000,
            ...
            490000, 480000, 470000, 460000, 450000, 440000, 430000, 420000, 410000, 400000,
    ...
    println!("{}", result_df.select([
        "date", "close", "sma_20", "sma_50", "macd", "macd_signal", "adx", "signal"
    ])?);
    ...
    if signals_df.height() > 0 {
        ...
        println!("{}", signals_df.select([
            "date", "close", "sma_20", "sma_50", "macd", "adx", "signal"
        ])?);
    } else {
