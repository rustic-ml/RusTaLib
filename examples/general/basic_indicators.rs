...
fn main() -> Result<(), PolarsError> {
    ...
    let close_prices = Series::new(
        ...
        &[
            ...
            97.0, 95.0, 94.0, 96.0, 98.0, 100.0, 102.0, 104.0, 105.0, 107.0, 109.0, 108.0, 110.0,
            112.0, 111.0, 109.0, 107.0, 105.0,
        ],
    );
    ...
    println!(
        "BB Middle(20,2): {}",
        bb_middle.f64()?.get(25).unwrap_or(f64::NAN)
    );
    println!(
        "BB Upper(20,2): {}",
        bb_upper.f64()?.get(25).unwrap_or(f64::NAN)
    );
    println!(
        "BB Lower(20,2): {}",
        bb_lower.f64()?.get(25).unwrap_or(f64::NAN)
    );
    ...
    println!(
        "Signal Line: {}",
        signal_line.f64()?.get(28).unwrap_or(f64::NAN)
    );
    println!(
        "Histogram: {}",
