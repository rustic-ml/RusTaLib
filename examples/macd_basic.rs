use polars::prelude::*;
use technical_indicators::indicators::oscillators::calculate_macd;
...
fn main() -> Result<(), PolarsError> {
    ...
    let close_prices = Series::new(
        "close".into(),
        &[
            100.0, 102.0, 104.0, 103.0, 105.0, 107.0, 108.0, 109.0, 110.0, 112.0,
            111.0, 113.0, 114.0, 116.0, 115.0, 114.0, 113.0, 112.0, 111.0, 110.0,
            109.0, 111.0, 113.0, 115.0, 117.0, 118.0, 120.0, 122.0, 121.0, 123.0,
        ],
    );
