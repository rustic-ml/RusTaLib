use polars::prelude::*;
use technical_indicators::indicators::moving_averages::{
...
fn main() -> Result<(), PolarsError> {
    ...
    let close_prices = Series::new(
        "close".into(),
        &[
            100.0, 101.0, 102.0, 103.0, 105.0, 107.0, 110.0, 113.0, 115.0, 116.0,
            115.0, 116.0, 115.0, 116.0, 115.0, 114.0, 115.0, 116.0, 117.0, 119.0,
            121.0, 123.0, 125.0, 127.0, 126.0,
        ],
    );
