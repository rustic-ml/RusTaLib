use polars::prelude::*;
use std::error::Error;
use ta_lib_in_rust::util::file_utils::{read_csv, read_csv_default, read_parquet, read_financial_data};
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("\nBasic summary:");
    println!("DataFrame has {} rows and {} columns", df3.height(), df3.width());
    ...
    println!("Financial data from CSV (no headers) - Shape: {:?}", df6.shape());
